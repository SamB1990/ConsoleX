...
# Contribute to  `ConsoleX`  development
...
1.  Check it doesn't already exist 
    > *as much as i appreciate you letting me know it can cause me extra confusion and time trying to reproduce fixed bugs you can check for existing bugs [here](https://github.com/SamB1990/ConsoleX/issues)*
...
4.  [Report](https://github.com/SamB1990/ConsoleX/issues/new) that bug.
